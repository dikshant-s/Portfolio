      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            computer vision techniques like lane detection, perspective transform, and object detection. The system is designed to autonomously recognize the road, detect lanes, and make driving decisions in real time.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
