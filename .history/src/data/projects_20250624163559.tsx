...
const PROJECT_SKILLS = {
  ...
  title: "OpenCV",
  bg: "white",
  fg: "#5C3EE8", // Choose a suitable shade (optional)
  icon: <SiOpencv />,
}
  prisma: {
    title: "prisma",
...
const projects: Project[] = [
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[`${BASE_PATH}/CSI/1.png`, `${BASE_PATH}/CSI/2.png`,`${BASE_PATH}/CSI/3.png`,`${BASE_PATH}/CSI/4_A.png`,`${BASE_PATH}/CSI/5.png`]}
          />
  ...
  },
  {
    ...
    screenshots: ["assets/projects-screenshots/personalfinancemanager/dashboard.png"],
      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            managing your finances. This responsive application allows you to manage your personal finances.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          ...
          <p className="font-mono mb-2">
            The Personal Finance Dashboard is a responsive web application that helps users 
            manage, visualize, and plan their finances. It provides a centralized platform 
            to track income, expenses, savings, investments, and budgets through interactive 
            charts and user-friendly forms.
          </p>
          <SlideShow
            images={[
          ...
          <p className="font-mono mb-2">
            It has both light and dark themes, ensuring a seamless user experience across different preferences.
          </p>
          <SlideShow images={[`${BASE_PATH}/personalfinancemanager/darkmode.png`]} />
          ...
          <p className="font-mono mb-2 mt-8 text-center">
            This is not just a dashboard; it's your financial companion, designed to help you 
            take control of your money and achieve your financial goals. Whether you're looking
            to save for a vacation, pay off debt, or simply keep track of your spending, this 
  ...
  },
  {
    ...
    skills: {
      ...
      backend: [PROJECT_SKILLS.arduino, PROJECT_SKILLS.opencv],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            computer vision techniques like lane detection, perspective transform, 
            and object detection. The system is designed to autonomously recognize 
            the road, detect lanes, and make driving decisions in real time.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
