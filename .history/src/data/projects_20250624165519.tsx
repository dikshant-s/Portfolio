...
const PROJECT_SKILLS = {
  ...
  kafka: {
    title: "Apache Kafka",
    bg: "#231F20", // Kafka's brand color
    fg: "white",
    icon: <SiApachekafka />,
  },
  zookeeper: {
    title: "Apache ZooKeeper",
    bg: "#f0ad4e", // Safari yellow (close to ZK branding)
    fg: "black",
    icon: <FaServer />,
  },
  streamlit: {
    title: "Streamlit",
    bg: "#FF4B4B", // Streamlit's official red
    fg: "white",
    icon: <SiStreamlit />,
  },
  machinelearning: {
...
const projects: Project[] = [
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/smartjobtracker/01.png",
    screenshots: [
      "01.png",
      "02.png",
      "03.png",
    ...
    github: "https://github.com/dikshant-s/HelmetDetection",
    skills: {
      frontend: [
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            This project implements a real-time helmet detection system using Apache Kafka for data streaming. A live video feed is captured (e.g., via a phone camera or IP camera), and frames are streamed through Kafka topics. These frames are processed using YOLOv5 and OpenCV to detect whether individuals are wearing helmets.

Zookeeper manages Kafka brokers, and Streamlit displays real-time results on a dashboard. This system is ideal for traffic surveillance, workplace safety monitoring, and compliance tracking.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
