      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            Kafka for data streaming. A live video feed is captured (e.g., via a phone 
            camera or IP camera), and frames are streamed through Kafka topics. These frames are processed using YOLOv5 and OpenCV to detect whether individuals are wearing helmets.
