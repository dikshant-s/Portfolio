      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            camera or IP camera), and frames are streamed through Kafka topics. These 
            frames are processed using YOLOv5 and OpenCV to detect whether individuals are wearing helmets.
