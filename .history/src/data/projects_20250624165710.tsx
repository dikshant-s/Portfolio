...
const projects: Project[] = [
  ...
  },
  {
    ...
    skills: {
      ...
      backend: [PROJECT_SKILLS.machinelearning, 
        PROJECT_SKILLS.opencv,
      ],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            This project implements a real-time helmet detection system using
            Apache Kafka for data streaming. A live video feed is captured
            (e.g., via a phone camera or IP camera), and frames are streamed
            through Kafka topics. These frames are processed using YOLOv5 and
            OpenCV to detect whether individuals are wearing helmets. Zookeeper
            manages Kafka brokers, and Streamlit displays real-time results on a
            dashboard. This system is ideal for traffic surveillance, workplace
